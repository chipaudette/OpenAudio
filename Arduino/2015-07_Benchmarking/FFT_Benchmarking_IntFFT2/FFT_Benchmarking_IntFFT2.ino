...
#define MAX_NFFT 2048
#define N_ALL_FFT 7
int ALL_N_FFT[N_ALL_FFT] = {MAX_NFFT, 1024, 512, 256, 128, 64, 32};
...
void loop() {
  ...
  for (int I_N_FFT = 0; I_N_FFT < N_ALL_FFT; I_N_FFT++) {
    ...
    while (count < N_LOOP) {
      ...
      //do fft
      ret_val = fix_fft(fft_cfg,real,imag,is_ifft);
