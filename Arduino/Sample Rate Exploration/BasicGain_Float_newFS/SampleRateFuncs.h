...
float calc_CYCLE_COUNTER_APPROX_PERCENT(int n, float fs_Hz) {
...
float AudioProcessorUsage_wFS(float fs_Hz) {
  return calc_CYCLE_COUNTER_APPROX_PERCENT(AudioStream::cpu_cycles_total, fs_Hz);
}
float AudioProcessorUsageMax_wFS(float fs_Hz) {
  return calc_CYCLE_COUNTER_APPROX_PERCENT(AudioStream::cpu_cycles_total_max, fs_Hz);
}
