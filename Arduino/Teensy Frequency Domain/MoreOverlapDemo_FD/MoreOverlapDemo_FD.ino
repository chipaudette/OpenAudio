// MoreOverlapDemo_FD
//
// Demonstrate audio procesing in the frequency domain.  Lots of overlap between FFT blocks.
//
// Created: Chip Audette  Oct 2017
//
// Approach:
...
void setup() {
 //begin the serial comms (for debugging)
  ...
  //int N_FFT = 128;
  int N_FFT = audio_block_samples*16;  // *2 is 50% overlap, *4 is 75% overlap, *8 is 87.5% overlap
