...
static __inline int ilog2(int n)
{
    int     m;
...
static __inline int bitrev(int ii, int m)
{
    register int jj;
...
static __inline void rad2(int ii, float *x0, float *x1)
{
    int     k;
    float   t;
...
static __inline void reorder1(int m, float *x)
{
    int     j, k, kl, n;
    float   t;
...
static __inline void reorder2(int m, float *x)
{
    int     ji, ij, n;
    float   t;
...
static void rcrad4(int ii, int nn,
...
static int rcfft2(float *x, int m)
{
    int     ii, nn, m2, it, n;
...
static void crrad4(int jj, int nn,
    float *x0, float *x1, float *x2, float *x3,
    float *x4, float *x5, float *x6, float *x7)
{
    double  arg, tpiovn;
...
static int crfft2(float *x, int m)
{
    int     n, i, it, nn, jj, m2;
