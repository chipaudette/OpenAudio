...
void setup() {
 ...
 Serial.println("StereoAudioToSD: memory allocated.");
  ...
  my_SD_writer.init();
  if (PRINT_SD_TIMING) my_SD_writer.enablePrintElapsedWriteTime(); //for debugging.  make sure time is less than (audio_block_samples/sample_rate_Hz * 1e6) = 2900 usec for 128 samples at 44.1 kHz
