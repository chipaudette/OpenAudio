...
void setup() {
  ...
  Serial.begin(115200);
  Serial1.begin(9600); //115200 for BT Classic, 9600 for adafruit bluefruit BLE
  delay(500);
  Serial.println("USB: Teensy Audio: NoiseTesting");
  Serial1.println("BT: Teensy Audio: NoiseTesting");
  ...
  Serial.print("USB: Headphone set to : "); Serial.println(headphone_val);
  Serial.print("BT: Headphone set to : "); Serial.println(headphone_val);
  sgtl5000_1.volume(headphone_val); //headphone volume (max linear is about 0.85)
  ...
  Serial.println("BT: adcHighPassFilter Disabled.");
...
void setLineInLevelFromPot(float val) {
  ...
  switch (1) {
    case 0:
      ...
      Serial.print("USB: Line In Setting: "); Serial.println(line_in_setting);
      Serial1.print("BT: Line In Setting: "); Serial1.println(line_in_setting);
      break;
    case 1:
      ...
      sgtl5000_1.lineInLevel(line_in_setting, line_in_setting); //max is 15, default is 5
      Serial.print("USB: LineIn Setting: "); Serial.println(line_in_setting);
      Serial1.print("BT: LineIn Setting: "); Serial1.println(line_in_setting);
      break;
  }
}
