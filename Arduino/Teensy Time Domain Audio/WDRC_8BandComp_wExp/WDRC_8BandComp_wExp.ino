...
AudioEffectCompWDRC2_F32  compBroadband[N_BBCOMP]; //here are the broad band compressors
...
AudioEffectCompWDRC2_F32  compPerBand[N_CHAN]; //here are the per-band compressors
...
static void configureBroadbandWDRCs(int ncompressors, float fs_Hz, BTNRH_WDRC::CHA_WDRC2 *gha, AudioEffectCompWDRC2_F32 *WDRCs) {
