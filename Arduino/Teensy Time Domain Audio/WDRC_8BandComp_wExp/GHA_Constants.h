...
static BTNRH_WDRC::CHA_DSL2 dsl = {5,  //attack (ms)
  300,  //release (ms)
  115, //calibration.  dB SPL for input signal at 0 dBFS.  Needs to be tailored to mic, spkrs, and mic gain.
  ...
  {40.0,40.0,40.0,40.0,40.0,40.0,40.0,40.0},          // expansion-end kneepoint
  {30.f, 30.f, 30.f, 30.f, 30.f, 30.f, 30.f, 30.f},  // compression-start gain
...
BTNRH_WDRC::CHA_WDRC2 gha = {5.f, // attack time (ms)
  ...
  115.f,    // calibration.  dB SPL for signal at 0dBFS.  Needs to be tailored to mic, spkrs, and mic gain.
