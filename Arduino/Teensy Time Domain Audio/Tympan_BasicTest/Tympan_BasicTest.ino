...
#if 1
  //use sine wave to test just the output portion
  AudioConnection         patchCord1(sine, 0, audioOutput, 0);
  AudioConnection         patchCord2(sine, 0, audioOutput, 1);
#else
  //use audio from microphones (or line in) and pipe to the audio output
