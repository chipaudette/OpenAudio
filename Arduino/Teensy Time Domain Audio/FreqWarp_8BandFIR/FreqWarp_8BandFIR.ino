...
//    if (0){
//      //audio connections to compressor
//      patchCord[count++] = new AudioConnection_F32(freqWarpFilterBank, i, expCompLim[i], 0); //connect filter to compressor
//  
//      //make connections to mixer
//      if (i < 8) {  
//        patchCord[count++] = new AudioConnection_F32(expCompLim[i], 0, mixer1, i); //connect to mixer 
//      } else {
//        patchCord[count++] = new AudioConnection_F32(expCompLim[i], 0, mixer2, i-8); //connect to mixer 
//      }
//      if (i == (N_CHAN-1)) {
//        //add connection of one mixer to another
//        patchCord[count++] = new AudioConnection_F32(mixer1, 0, mixer2, N_CHAN-8); //connect to mixer 
//      }
//    } else {
      //no compressor.  Just make connections to mixer
//      if (i < 8) {  
//        patchCord[count++] = new AudioConnection_F32(freqWarpFilterBank, i, mixer1, i); //connect to mixer 
//      } else {
//        patchCord[count++] = new AudioConnection_F32(freqWarpFilterBank, i, mixer2, i-8); //connect to mixer 
 //     }
//      if (i == (N_CHAN-1)) {
//        //add connection of one mixer to another
//        patchCord[count++] = new AudioConnection_F32(mixer1, 0, mixer2, N_CHAN-8); //connect to mixer 
...
//    }
    ...
    //make the connection for the audio test measurements
    patchCord[count++] = new AudioConnection_F32(freqWarpFilterBank, i, audioTestMeasurement_FIR, 1+i);
  }
 ...
 // patchCord[count++] = new AudioConnection_F32(freqWarpFilterBank, 4, mixer1, 4);
  ...
  patchCord[count++] = new AudioConnection_F32(freqWarpFilterBank, 0, i2s_out, 0);  //left output
  patchCord[count++] = new AudioConnection_F32(freqWarpFilterBank, 0, i2s_out, 1);  //right output
...
void setup() {
  ...
  AudioMemory_F32_wSettings(60,audio_settings);  //allocate Float32 audio data blocks (primary memory used for audio processing)
